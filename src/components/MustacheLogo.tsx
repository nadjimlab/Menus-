...
export const MustacheIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-2.5' }) => (
  <svg
    className={`${className} fill-current drop-shadow-[0_1px_1px_rgba(0,0,0,0.3)]`}
    viewBox="0 0 100 50"
...
export const MustacheLogo: React.FC<MustacheLogoProps> = ({
  ...
  return (
    <div className={`flex items-center gap-3.5 ${className}`}>
      ...
      >
        <MustacheIcon className={`${dimensions.mustache} text-black relative z-10`} />
      </div>
